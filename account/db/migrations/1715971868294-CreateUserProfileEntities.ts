...
export class CreateUserProfileEntities1715971868294 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "profile" ("id" uuid NOT NULL, "type" "public"."profile_type_enum" NOT NULL, "info" jsonb NOT NULL, "visible" "public"."profile_visible_enum" NOT NULL DEFAULT 'Open', "updated_date" TIMESTAMP NOT NULL DEFAULT now(), "created_date" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "categoryId" uuid, CONSTRAINT "PK_3dd8bfc97e4a77c70971591bdcb" PRIMARY KEY ("id"))`);
