...
export default function EditProfile() {
    ...
    return (
        <div className={styles.container}>
            <HeaderLoadPhoto title='Загрузить фото' text='По умолчанию будет использоваться фото самой первой созданной анкеты' />
            <div className={styles.content}>
                ...
                <div className={styles.btnWrap}>
                    <Button text='Сохранить' onClick={() => console.log('')} variant='primary'/>
                    <Button text='Отмена' onClick={() => router.back()} variant='secondary' className={styles.btnText}/>
                </div>
            </div>
