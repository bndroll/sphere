...
export default function CreateEvent() {
    ...
    return (
        <div className={styles.container}>
            <HeaderLoadPhoto title='Загрузить логотип' text='Рекомендуем загружать квадратное фото' />
            ...
            <div className={styles.card}>
                ...
                <span className={styles.cardText}>Рекомендуем вертикальные светлые фотографии в хорошем качестве, передающие атмосферу мероприятия.</span>
            </div>
            ...
            <div className={styles.btnWrap}>
                <Button text='Создать' onClick={() => console.log('')} variant='primary'/>
                <Button text='Отмена' onClick={() => router.back()} variant='secondary' className={styles.whiteText}/>
            </div>
        </div>
    )
}